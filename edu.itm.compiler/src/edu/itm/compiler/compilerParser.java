...
public class compilerParser extends org.antlr.runtime.Parser {
    ...
    public void displayRecognitionError(String[] tokenNames, org.antlr.runtime.RecognitionException e) {
        ...
        String linea = "Que te fijes!!!: " + hdr + " " + msg + "\n";
        if (salida != null) {
            salida.append(linea);
        } else {
    ...
    public String[] getTokenNames() {
        return compilerParser.tokenNames;
    }
    ...
    private void pushID(String id, String tipo) {
        ...
        salida.append("Insertando a TS:  " + id + "  con tipo:  " + tipo + "\n");
        ...
        try {
            ...
            // compiler.g:39:10: ( classes )+
            {
                ...
                while (true) {
                    ...
                    switch (alt1) {
                        case 1: // compiler.g:39:10: classes
                        {
        ...
        try {
            ...
            // compiler.g:41:10: accesmod CLASS ID OCURLYB ( member )* CCURLYB
            {
                ...
                while (true) {
                    ...
                    switch (alt2) {
                        case 1: // compiler.g:43:25: member
                        {
    ...
    public final void assignment() throws RecognitionException {
        ...
        try {
            ...
            // compiler.g:45:21: ID '=' expr SEMICOLON
            {
                ...
                salida.append("Tipo de expr es  : " + expr1 + "\n");
    ...
    public final void member() throws RecognitionException {
        try {
            ...
            switch (alt3) {
                case 1: // compiler.g:49:21: method
                {
                ...
                break;
                case 2: // compiler.g:49:31: property
                {
        ...
        try {
            ...
            // compiler.g:51:21: accesmod tipo ID ( COMMA ID )* SEMICOLON
            {
                ...
                while (true) {
                    ...
                    switch (alt4) {
                        case 1: // compiler.g:51:40: COMMA ID
                        {
    ...
    public final void method() throws RecognitionException {
        try {
            ...
            // compiler.g:53:21: accesmod tipo ID '(' ( decl_args )? ')' OCURLYB ( sentences )* CCURLYB
            {
                ...
                switch (alt5) {
                    case 1: // compiler.g:53:42: decl_args
                    {
                ...
                while (true) {
                    ...
                    switch (alt6) {
                        case 1: // compiler.g:55:41: sentences
                        {
        ...
        try {
            ...
            // compiler.g:58:21: t1= tipo id1= ID ( COMMA t2= tipo id2= ID )*
            {
                ...
                while (true) {
                    ...
                    switch (alt7) {
                        case 1: // compiler.g:59:26: COMMA t2= tipo id2= ID
                        {
        ...
        try {
            ...
            // compiler.g:60:21: tipo id1= ID ( COMMA id2= ID )* SEMICOLON
            {
                ...
                while (true) {
                    ...
                    switch (alt8) {
                        case 1: // compiler.g:61:26: COMMA id2= ID
                        {
    ...
    public final void sentences() throws RecognitionException {
        try {
            ...
            switch (alt9) {
                case 1: // compiler.g:63:21: assignment
                {
                ...
                break;
                case 2: // compiler.g:63:34: decl_local
                {
        ...
        try {
            ...
            // compiler.g:65:31: m1= multExpr ( ( '+' | '-' ) m2= multExpr )*
            {
                ...
                while (true) {
                    ...
                    switch (alt10) {
                        case 1: // compiler.g:66:34: ( '+' | '-' ) m2= multExpr
                        {
        ...
        try {
            ...
            // compiler.g:71:21: a1= atom ( '*' a2= atom )*
            {
                ...
                while (true) {
                    ...
                    switch (alt11) {
                        case 1: // compiler.g:72:22: '*' a2= atom
                        {
